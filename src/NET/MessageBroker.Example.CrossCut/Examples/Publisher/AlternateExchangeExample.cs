...
public class AlternateExchangeExample : BaseExchangeExample
{
    ...
    public AlternateExchangeExample(IConnectionFactory connectionFactory, IExampleInputProvider inputProvider, IExampleOutputHandler outputHandler)
    ...
    protected override async Task CreateTestEnvironment(CancellationToken ct)
    {
        ...
        await _outputHandler.WriteOutputAsync("Binding queues with the respective routing keys: abc and dfg", ct);
